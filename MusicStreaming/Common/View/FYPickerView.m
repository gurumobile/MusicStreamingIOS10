...
- (void)initHeadView:(CGRect)frame {
    ...
    [del setTitle:@"Cancel" forState:UIControlStateNormal];
    [del setTitle:@"Cancel" forState:UIControlStateHighlighted];
    ...
    [ent setTitle:@"OK" forState:UIControlStateNormal];
    [ent setTitle:@"OK" forState:UIControlStateHighlighted];
